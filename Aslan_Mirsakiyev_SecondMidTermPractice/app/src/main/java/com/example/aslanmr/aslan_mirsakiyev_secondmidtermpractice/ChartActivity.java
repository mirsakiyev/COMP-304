    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (checkedStates[3]==0)
            {
                ...
                barY += barHeight;paint.setColor(Color.GREEN);
        ...
        imageView.invalidate(); //refresh the painting
